...
git add -A
git commit -m "Ciclos de faturamento: janelas fixas ancoradas no calendario + 5 status (aberto/fechado/a vencer/pago/vencido) - espelha o novo modelo do banco/web"
git push
