...
echo "== flutter pub get (baixa flutter_map + latlong2, novas dependencias) =="
flutter pub get
...
git add -A
git commit -m "FLT-3: Roteirizador Inteligente + mapas OSM (cliente) - OSRM, algoritmo de paradas, flutter_map"
git push
