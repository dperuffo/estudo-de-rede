  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text('Novo Sinistro')),
      body: ListView(
        ...
        children: [
          ...
          DropdownButtonFormField<String?>(
            ...
            items: [
              const DropdownMenuItem(value: null, child: Text('Selecione...')),
              for (final g in gravidadesSinistro)
          ...
          TextField(
            ...
            decoration: const InputDecoration(
                labelText: 'Descrição',
                hintText: 'Circunstâncias do sinistro...',
                border: OutlineInputBorder()),
          ),
