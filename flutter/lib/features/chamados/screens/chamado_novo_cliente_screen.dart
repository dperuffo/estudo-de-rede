...
// `prioridadesTicket` do Posto (100% genéricos — ver comentário em
// chamados_cliente_screen.dart). Única diferença: rota final sem prefixo
// `/posto`.
class ChamadoNovoClienteScreen extends ConsumerStatefulWidget {
