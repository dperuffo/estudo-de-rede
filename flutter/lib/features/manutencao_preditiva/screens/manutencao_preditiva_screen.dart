...
import '../../centros_custo/providers/centros_custo_provider.dart'
    show CentroCusto, centrosCustoClienteProvider;
...
class ManutencaoPreditivaScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ManutencaoPreditivaScreen> createState() =>
      _ManutencaoPreditivaScreenState();
}

class _ManutencaoPreditivaScreenState
    extends ConsumerState<ManutencaoPreditivaScreen> {
      ...
      body: ListView(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: const [
              DropdownMenuItem(
                  value: 'score', child: Text('Pior estado primeiro')),
      ...
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            _indicador('🔴 Críticos', '${k.totalCriticos}',
                destaque: k.totalCriticos > 0),
          ],
        ),
          ...
          children: [
            ...
            Text('${v.scoreGeral}/100',
                style: TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w700,
                    color: corBarraScore(v.scoreGeral.toDouble()))),
          ],
        ),
        subtitle: Padding(
            ...
            children: [
              Text(
                '${[
                  v.marca,
                  v.modelo
                ].where((s) => s != null && s.isNotEmpty).join(' ')}${v.marca == null && v.modelo == null ? '—' : ''}'
              ...
              if (v.nCriticos > 0 || v.nAlertas > 0)
                Padding(
                  ...
                  child: Row(
                    children: [
                      if (v.nCriticos > 0)
                        Text('${v.nCriticos} crítico(s)  ',
                            style: const TextStyle(
                                fontSize: 11, color: Color(0xFFDC2626))),
                      if (v.nAlertas > 0)
                        Text('${v.nAlertas} alerta(s)',
                            style: const TextStyle(
