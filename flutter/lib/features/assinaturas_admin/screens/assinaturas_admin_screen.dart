  ...
  Widget _lista(IndicadoresFinanceirosFni d) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text(
            'FATURAMENTO — ${_mesesLabel[agora.month - 1].toUpperCase()} DE ${agora.year}',
            style: TextStyle(
                fontSize: 11,
        ...
        GridView.count(
          ...
          children: [
            _indicador(
                'Faturado no mês', _moeda.format(d.faturamentoMesCents / 100)),
            _indicador('Inadimplência no mês',
                '${_moeda.format(d.inadimplenciaMesCents / 100)} (${d.qtdInvoicesFalhas})',
                destaque:
                    d.qtdInvoicesFalhas > 0 ? _Cor.negativo : _Cor.neutro),
            _indicador('Novos assinantes', '${d.novosAssinantesDoMes}',
                destaque:
                    d.novosAssinantesDoMes > 0 ? _Cor.positivo : _Cor.neutro),
            _indicador('Churn (cancelados)', '${d.churnDoMes.length}',
                destaque:
                    d.churnDoMes.isNotEmpty ? _Cor.negativo : _Cor.neutro),
          ],
        ),
        const SizedBox(height: 16),
        Card(
        ...
        Text('CLIENTES (${d.empresas.length})',
            style: TextStyle(
                fontSize: 11,
                fontWeight: FontWeight.w700,
                color: Colors.grey.shade500,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(statusEmpresaLabel[e.status] ?? e.status,
                      style: TextStyle(
                          fontSize: 10,
                          color: corStatus,
                          fontWeight: FontWeight.w700)),
            ...
            Text(planoLabel[e.plano] ?? e.plano,
