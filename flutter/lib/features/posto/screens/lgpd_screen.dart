...
class _LgpdScreenState extends ConsumerState<LgpdScreen> {
  ...
  Future<void> _revogarConsentimento() async {
    ...
    setState(() {
      ...
      if (erro != null) {
        ...
        _sucessoRevogacao =
            'Revogação de consentimento registrada com sucesso.';
      }
    });
  ...
  Future<void> _solicitarExclusao(String empresaId) async {
    ...
    final erro =
        await LgpdService().solicitarExclusaoDados(empresaId: empresaId);
    if (!mounted) return;
    setState(() {
      ...
      if (erro != null) {
        ...
        _sucessoExclusao =
            'Solicitação de exclusão registrada. A equipe FNI vai analisar e retornar por e-mail.';
      }
    });
    if (erro == null) ref.invalidate(lgpdProvider);
  }
  ...
  Widget _buildConteudo(BuildContext context, LgpdDetalhe dados) {
    _empresaSelecionada ??= dados.empresasVinculadas.isNotEmpty
        ? dados.empresasVinculadas.first.id
        : null;
          ...
          child: dados.dados == null
              ...
              : Column(
                  ...
                  children: [
                    ...
                    _linhaDado('Cadastrado em',
                        _dataHoraFormatada(dados.dados!.criadoEm)),
                    _linhaDado('MFA',
                        dados.dados!.mfaHabilitado ? 'Ativada' : 'Não ativada'),
                  ],
                ),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              OutlinedButton(
                ...
                child: Text(
                    _revogando ? 'Registrando...' : 'Revogar consentimento'),
              ),
            ],
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              if (dados.empresasVinculadas.isEmpty)
                ...
                OutlinedButton(
                  onPressed:
                      (_solicitandoExclusao || _empresaSelecionada == null)
                          ? null
                          : () => _solicitarExclusao(_empresaSelecionada!),
                  child: Text(_solicitandoExclusao
                      ? 'Enviando...'
                ...
                ...dados.exclusoes.map((ex) => Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                                'Solicitado em ${_dataHoraFormatada(ex.solicitadoEm)}',
                      ...
                      .map((c) => Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                      tipoConsentimentoLabel[c.tipo] ?? c.tipo,
