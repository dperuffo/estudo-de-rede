    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () =>
              context.canPop() ? context.pop() : context.go('/posto/clientes'),
        ),
      ),
      body: async.when(
        ...
        data: (d) {
          ...
          return RefreshIndicator(
            onRefresh: () async =>
                ref.invalidate(clientePostoDetalheProvider(id)),
            child: ListView(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('CNPJ: ${formatarCnpj(c.cnpj)}',
                            style: const TextStyle(fontSize: 13)),
                        if (c.municipio != null)
                          Text('Cidade/UF: ${c.municipio}/${c.uf ?? ''}',
                              style: const TextStyle(fontSize: 13)),
                        if (c.segmentoTransporte != null)
                          Text('Segmento: ${c.segmentoTransporte}',
                              style: const TextStyle(fontSize: 13)),
                        if (c.porte != null)
                          Text('Porte: ${c.porte}',
                              style: const TextStyle(fontSize: 13)),
                        if (c.telefoneContato != null)
                          Text('Telefone: ${c.telefoneContato}',
                              style: const TextStyle(fontSize: 13)),
                        if (c.emailContato != null)
                          Text('E-mail: ${c.emailContato}',
                              style: const TextStyle(fontSize: 13)),
                      ],
                    ),
                  ),
                ...
                if (d.cicloAtual == null)
                  ...
                  Card(
                    child: InkWell(
                      onTap: () => context.push(
                          '/posto/ciclos-abertos/${d.cicloAtual!.negociacaoId}'),
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
