...
// Fase FLT-2 — "Abastecimentos Fornecidos" da visão Posto, espelhando (com
// escopo reduzido — ver README) AbastecimentosPosto.tsx da web: o que este
// posto forneceu aos clientes, multi-provedor (PróFrotas + externos).
class AbastecimentosPostoScreen extends ConsumerStatefulWidget {
...
class _AbastecimentosPostoScreenState extends ConsumerState<AbastecimentosPostoScreen> {
  ...
  String? _provedor;
  String? _clienteId;
  Future<ResultadoAbastecimentosPosto>? _futuro;
  ...
  void _carregar() {
    ...
    setState(() {
      _futuro = _service.buscar(
        ...
        filtros: FiltrosAbastecimentosPosto(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Buscar por ID, placa, motorista ou cliente',
  ...
  Widget _linhaRegistro(RegistroAbastecimentoPosto r, ResultadoAbastecimentosPosto dados) {
    ...
    final motivoPendencia = dados.pendenciaPorAbastecimento[r.chave];
