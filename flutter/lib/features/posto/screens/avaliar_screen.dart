...
// Fase FLT-2 — porta de FormularioAvaliacao.tsx + página de avaliar/. Sem
// o seletor de "sobre qual cliente é esta avaliação" (só faz sentido pra
// quem enxerga vários clientes — o shell /posto sempre tem uma única
// empresa atual, já resolvida via sessão/seletor de posto).
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      hintText:
                          'Conte pra gente o que está funcionando bem ou o que podemos melhorar.',
                    ),
                  ),
                  if (_erro != null) ...[
                    const SizedBox(height: 12),
                  ...
                  SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      child:
                          Text(_enviando ? 'Enviando...' : 'Enviar avaliação'),
                    ),
                  ),
                ],
              ),
