...
import '../providers/ciclo_aberto_detalhe_provider.dart';
...
// Fase FLT-2 — pedido do Daniel: detalhamento do ciclo em andamento, porta
// com escopo reduzido (ver README) de ciclo-aberto/[negociacaoId]/page.tsx:
// período/vencimento/valor PREVISTOS (o robô fecha automaticamente quando
// o ciclo termina, virando fatura de verdade) + lista de abastecimentos
// com filtro por status de NF-e.
class CicloAbertoDetalheScreen extends ConsumerStatefulWidget {
  final String negociacaoId;
  const CicloAbertoDetalheScreen({super.key, required this.negociacaoId});

  @override
  ConsumerState<CicloAbertoDetalheScreen> createState() =>
      _CicloAbertoDetalheScreenState();
}

class _CicloAbertoDetalheScreenState
    extends ConsumerState<CicloAbertoDetalheScreen> {
