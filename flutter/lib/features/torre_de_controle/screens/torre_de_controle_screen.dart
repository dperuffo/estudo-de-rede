    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: fretesAsync.when(
          data: (fretes) =>
              _corpo(context, fretes, posicoesAsync.value ?? const []),
    ...
    return ListView(
      ...
      children: [
        ...
        if (posicoes.isNotEmpty) ...[
          ...
          Text(
              'Mapa ao vivo (${posicoes.length} veículo${posicoes.length == 1 ? '' : 's'})',
              style:
        ...
        Row(
          children: [
            Expanded(
                child: _cardResumo('Em andamento', '${fretes.length}', null)),
            const SizedBox(width: 8),
            Expanded(
                child: _cardResumo('Vencendo ≤6h', '$totalVencendo',
                    totalVencendo > 0 ? Colors.amber : null)),
          ],
        ),
        const SizedBox(height: 8),
        Row(
          children: [
            Expanded(
                child: _cardResumo('Prazo estourado', '$totalAtrasados',
                    totalAtrasados > 0 ? Colors.red : null)),
            const SizedBox(width: 8),
            Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 4,
                children: [
                  Text('Motorista: ${f.nomeMotorista ?? '—'}',
