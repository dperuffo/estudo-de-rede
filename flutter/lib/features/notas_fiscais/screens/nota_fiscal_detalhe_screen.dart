          ...
          return ListView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                      child: _cardParte('Emitente (posto)', nota.nomeEmitente,
                          nota.cnpjEmitente)),
                  const SizedBox(width: 10),
                  Expanded(
                      child: _cardParte('Destinatário (cliente)',
                          nota.nomeDestinatario, nota.cnpjDestinatario)),
                ],
              ),
              const SizedBox(height: 16),
              Text('Item de combustível',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _linha('Valor total', _moeda.format(nota.valorTotal),
                          destaque: true),
                    ],
                  ),
                ),
              ),
              if (nota.abastecimentoData != null ||
                  nota.veiculoPlaca != null ||
                  nota.motoristaNome != null) ...[
                const SizedBox(height: 16),
                Text('Abastecimento vinculado',
                    style: Theme.of(context).textTheme.titleSmall),
                const SizedBox(height: 8),
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        if (nota.abastecimentoData != null)
                          _linha('Data', _fmtData(nota.abastecimentoData!)),
                        if (nota.veiculoPlaca != null)
                          _linha('Placa', nota.veiculoPlaca!),
                        if (nota.motoristaNome != null)
                          _linha('Motorista', nota.motoristaNome!),
                      ],
                    ),
                  ),
                ),
