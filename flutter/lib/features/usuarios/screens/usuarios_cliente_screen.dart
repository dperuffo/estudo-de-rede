...
// espírito de Chamados: só as rotas mudam (sem prefixo `/posto`).
class UsuariosClienteScreen extends ConsumerWidget {
  const UsuariosClienteScreen({super.key});
  ...
  Widget _cardUsuario(BuildContext context, UsuarioDoPosto u) {
    return Card(
      ...
      child: ListTile(
        onTap: () =>
            context.push('/usuarios/${Uri.encodeComponent(u.email)}'),
