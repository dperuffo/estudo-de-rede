...
import '../../centros_custo/providers/centros_custo_provider.dart' show centrosCustoClienteProvider;
...
class _TcoScreenState extends ConsumerState<TcoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('TCO — Custo Total de Propriedade')),
              ...
              children: [
                ...
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    items: const [
                      DropdownMenuItem(value: 'custo_por_km_desc', child: Text('Maior custo/km')),
                      DropdownMenuItem(value: 'custo_por_km_asc', child: Text('Menor custo/km')),
                      DropdownMenuItem(value: 'tco_total_desc', child: Text('Maior TCO total')),
                    ],
                    onChanged: (v) => setState(() {
                      _ordenar = v ?? _ordenar;
                      _pagina = 1;
  ...
  Widget _corpo(List<VeiculoResumoTco> lista) {
    ...
    final custoPorKmMedio = comKm.isEmpty ? 0.0 : comKm.fold<double>(0, (s, v) => s + (v.custoPorKm ?? 0)) / comKm.length;
      ...
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            _indicador('Custo/km médio', custoPorKmMedio > 0 ? '${_moeda.format(custoPorKmMedio)}/km' : '—'),
          ],
        ),
        const SizedBox(height: 8),
        _indicador('Sem dado de aquisição', '$semAquisicao', destaque: semAquisicao > 0),
        if (semAquisicao > 0) ...[
        ...
        if (totalPaginas > 1) ...[
          ...
          Row(
            ...
            children: [
              ...
              Row(
                children: [
                  TextButton(onPressed: _pagina > 1 ? () => setState(() => _pagina--) : null, child: const Text('← Anterior')),
                  TextButton(onPressed: _pagina < totalPaginas ? () => setState(() => _pagina++) : null, child: const Text('Próxima →')),
                ],
              ),
            ],
          ),
      ...
      child: ListTile(
        ...
        title: Row(
          children: [
            ...
            Text(_moeda.format(v.tcoTotal), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
          ],
        ),
        subtitle: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    v.custoPorKm != null ? '${_moeda.format(v.custoPorKm!)}/km' : 'custo/km indisponível',
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: v.tcoCompleto ? const Color(0xFFECFDF5) : const Color(0xFFFFFBEB),
