...
// Fase FLT-4 — porta fiel de criarGrupoEconomico/atualizarGrupoEconomico/
// vincularEmpresaAoGrupo/desvincularEmpresaDoGrupo (src/lib/
// gruposEconomicos.ts), caminho segmento='Frota' (100% admin-only, sem
// self-service — ver comentário completo em
// grupo_economico_admin_provider.dart). Diferente de
// posto/services/rede_postos_service.dart (Rede de Postos, segmento
// Revenda), aqui NÃO existe RPC self-service (`criar_rede_posto_self_
// service` só aceita fundador Revenda) — criar Grupo Econômico é um
// INSERT direto em `grupos_economicos`, garantido pela RLS
// `grupos_insert` (só passa se `perfil_usuario_atual() = 'admin'` pra
// segmento='Frota'). O resto (atualizar/vincular/desvincular) é
...
class GrupoEconomicoAdminService {
