                    ...
                    DataColumn(
                        label: Text('Atualizado em',
                            style: TextStyle(
                                fontSize: 11, fontWeight: FontWeight.w700))),
                    DataColumn(
                        label: Text('Atualizado por',
                            style: TextStyle(
                                fontSize: 11, fontWeight: FontWeight.w700))),
                  ],
                  rows: posto.precos
                      .map((p) => DataRow(cells: [
                            DataCell(Text(p.combustivel,
                                style: const TextStyle(fontSize: 12))),
                            DataCell(Text('R\$ ${p.preco.toStringAsFixed(3)}',
                                style: const TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600))),
                            DataCell(Text(_dataHora(p.atualizadoEm),
                                style: const TextStyle(fontSize: 11))),
                            DataCell(Text(p.atualizadoPor ?? '—',
                                style: const TextStyle(fontSize: 11))),
                          ]))
                      .toList(),
                ),
