...
import '../../posto/providers/rede_posto_provider.dart'
    show PostoVinculado, RedePostoDetalhe;
...
final redesPostosAdminListaProvider =
    FutureProvider.autoDispose<List<RedePostoResumo>>((ref) async {
...
final kpisRedesPostosProvider =
    Provider.autoDispose<AsyncValue<KpisRedesPostos>>((ref) {
...
final redePostoAdminDetalheProvider = FutureProvider.autoDispose
    .family<RedePostoDetalhe?, String>((ref, redeId) async {
