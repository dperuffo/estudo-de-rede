...
// Implementação pura-Dart de SHA-256 (sem dependência de pacote externo —
// mesmo motivo do cte_parser.dart: não dá pra rodar `flutter pub get` neste
// ambiente com segurança pra adicionar o pacote `crypto`, então isto é
// escrito à mão). Usado só por conciliacao_bancaria_service.dart pra gerar
// o mesmo hash de dedupe (`hash_dedupe`) que a web calcula em
// calcularHashDedupe() (src/lib/conciliacaoBancaria.ts), garantindo que um
// lançamento já importado pela web não seja duplicado ao importar pelo
// PWA (e vice-versa) — o hash precisa ser bit-a-bit igual ao SHA-256 real.
String sha256Hex(String texto) {
