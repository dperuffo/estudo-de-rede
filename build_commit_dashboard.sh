...
git add -A
git commit -m "Dashboard: 2 abas (Visao Geral + Indicadores Avancados) - Ajustes de Abastecimento, Centro de Custo, Manutencao Preditiva, Primeiros Passos e os 8 indicadores avancados por periodo"
git push
